    ...
    <>
      ...
      <div className="px-5 py-4 border-b border-white/10">
        <div className="flex items-center justify-between">
          <Link href="/dashboard" data-testid="link-logo-home" className="hover:opacity-90 transition-opacity">
  ...
  return (
    <>
      ...
      <header className="lg:hidden fixed top-0 left-0 right-0 z-40 bg-primary text-white h-14 flex items-center justify-between px-4 shadow-lg">
        ...
        <Link href="/dashboard" data-testid="link-logo-mobile-header" className="hover:opacity-90 transition-opacity">
