...
export default function IncomeDisclosurePage() {
  usePageMeta(
    "Income Disclosure Statement | LeaderShield Funding",
      ...
      <main className="max-w-4xl mx-auto px-6 py-12">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground leading-relaxed" data-testid="text-important-notice">
                  ...
                  you understand the potential earnings from participation in the LeaderShield Funding opportunity.
                  <strong className="text-foreground"> The majority of participants in the LeaderShield Funding earn little to no income.</strong> Your
        ...
        <section className="mb-10">
          ...
          <p className="text-muted-foreground leading-relaxed mb-4">
            LeaderShield Funding, LLC ("LeaderShield," "the Company," "we," or "us") is committed to full
          ...
          <p className="text-muted-foreground leading-relaxed">
            This disclosure provides actual income data from all active and inactive LeaderShield Funding
        ...
        <section className="mb-10">
          ...
          <p className="text-sm text-muted-foreground mb-4 leading-relaxed">
            The following table shows income data for each rank level within the LeaderShield Funding
        ...
        <section className="mb-10">
          ...
          <div className="space-y-4 text-muted-foreground leading-relaxed">
            <p>
              ...
              LeaderShield Funding at any point during the fiscal year ending December 31, 2024. This
            ...
            <p>
              Income includes all forms of compensation paid by LeaderShield Funding including, but not
        ...
        <section className="mb-10">
          ...
          <div className="space-y-4 text-muted-foreground leading-relaxed">
            <p>
              LeaderShield Funding makes <strong className="text-foreground">no guarantees regarding income</strong>, whether express or implied.
            ...
            <p>
              ...
              of LeaderShield Funding are unauthorized and should be reported to the Company immediately.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-4 text-muted-foreground leading-relaxed">
            <p>Your income as a LeaderShield Funding participant may be affected by many factors, including but not limited to:</p>
            <ul className="list-disc pl-6 space-y-2">
        ...
        <section className="mb-10">
          ...
          <p className="text-muted-foreground leading-relaxed">
            LeaderShield Funding participants are independent contractors and are not employees of
            LeaderShield Funding, LLC. As independent contractors, participants are responsible for their
            own business expenses, tax obligations, insurance, and compliance with all applicable federal,
            state, and local laws and regulations. LeaderShield Funding does not withhold taxes, provide
        ...
        <section className="mb-10">
          ...
          <p className="text-muted-foreground leading-relaxed">
            LeaderShield Funding is not a pyramid scheme. Commissions and bonuses are earned based on the
        ...
        <Card className="mb-10 border-border">
          <CardContent className="p-6">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed mb-4">
              If you have any questions about this Income Disclosure Statement or the LeaderShield Funding
              compensation plan, please contact our Compliance Department:
            </p>
            <div className="text-sm text-muted-foreground space-y-1">
              <p>LeaderShield Funding, LLC — Compliance Department</p>
        ...
        <div className="text-center pb-12">
          <p className="text-xs text-muted-foreground mb-6">
            ...
            constitute an offer or solicitation of a business opportunity. LeaderShield Funding reserves
